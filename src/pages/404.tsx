    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center h-screen bg-black">
                ...
                <div className="flex flex-col items-center p-10 px-16 rounded-3xl z-10 bg-dot">
                    <h1 className="text-6xl font-bold text-white">Error <span className='text-red-500'>404</span></h1>
                    <h2 className="text-2xl font-bold text-white">Page Not Found</h2>
                </div>
                <p className='absolute text-[48rem] z-0 text-[#080808] leading-3 select-none'>404</p>
            </div>
        </>
    )
}
