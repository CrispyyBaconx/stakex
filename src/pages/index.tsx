	...
	return (
		<>
			...
			<main className='App'>
				...
				<ParallaxBanner className='bg-inset h-[95rem]' layers={[{ image: cardsBackground.src, speed: 30 }, {
					children: (
						<section className="flex flex-col items-center">
							<div className='flex flex-row bg-gradient-to-r from-black px-28 h-full w-full justify-center'>
                				...
                				<div className='flex flex-col items-center justify-center w-1/6 mx-72'>
                				    <div className='flex flex-col items-center justify-center w-1 h-full bg-slate-400 rounded-full'></div>
                				</div>
