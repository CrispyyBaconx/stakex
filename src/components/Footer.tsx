            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="https://stakex.io/" className="flex items-center">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="https://stakex.io/" className="hover:underline">Stakex</a>
                                </li>
                                <li>
                                    <a href="https://google.com/" className="hover:underline">Woble Center</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://stakex.io/" className="hover:underline">Stakex™</a>. All Rights Reserved.</span>
