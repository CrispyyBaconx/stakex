    ...
    return (
        <div className="flex relative justify-center items-center my-8 w-4/5">
            <div className='flex flex-row'>
                ...
                <Image className='w-full h-full max-w-3xl rounded-lg border-[3px] border-gray-700 hover:cursor-pointer' src={current.image} key={index} alt='' height={350} width={800} onClick={() => { router.push(current.link).then().catch(console.error) }} />
